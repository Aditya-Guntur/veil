...
└─────────────────────────────────────────────────────────────────────┘
                         ...
                         auction.rs
                            ...
                            │    │ $3100 | 10 ETH | 0 ETH │
                            │    │ $3005 | 60 ETH | 15 ETH│
                            │    │ $3001 | 60 ETH | 60 ETH│ ← MATCH!
                            │    └────────────────────────┘
                            │
                            ├──> 4. Find Intersection
                            │    • Max volume: 60 ETH
                            │    • Clearing price: $3,001
                            │
                            ├──> 5. Match Orders
                            │    • Calculate fills
                            │    • Calculate surplus
                            ...
                            │
                            └──> 6. Return ClearingResult
                                 • clearing_price: $3,001
                                 • total_volume: 60 ETH
                                 • total_surplus: $1,300
...
│  │  Value: UserStats {                                           │ │
│  │    user, total_orders, filled_orders,                         │ │
...
│  │    • Sell: Lock amount BTC                               │       │
│  │                                                          │       │
│  │  At Settlement:                                          │       │
│  │    • Release locked funds                                │       │
│  │    • Transfer assets based on clearing price             │       │
...
| **encryption.rs** | — | lib.rs | None | vetkeys_engine |
| **timers.rs** | lib.rs | IC Heartbeat | STATE | None |
| **queries.rs** | types.rs | Frontend | ORDERS, RESULTS, USER_STATS | None |
| **ethereum.rs** | — | lib.rs | None | IC Management (ECDSA) |
| **bitcoin.rs** | — | lib.rs | None | IC Management (Schnorr) |
| **vetkeys_engine** | — | encryption.rs | None | IC vetKD API |
